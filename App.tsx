...
function App() {
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p className="mt-2 text-sm text-gray-500 w-[285px] h-[72px] left-[102.01px] top-[4703px] gap-[0px] leading-[24px]
...
">
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      ...
      <div className="lg:w-2/5 md:w-1/2 w-full p-4 ">
        <h2 className="title-font font-medium text-gray-700 tracking-widest text-sm mb-3 ">
         Newsletter
      <span className='mx-4 underline  gap-5'>
        <br />
        Enter your email Address

    
        
       <span className='mx-4 underline text-black '>
       <br />
